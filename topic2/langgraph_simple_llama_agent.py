...
class AgentState(TypedDict):
    ...
    should_exit: bool
    llm_response: str
    verbose: bool # Boolean flag for tracing output (set by get_user_input)
    is_command: bool
...
def create_graph(llm):
    ...
    def get_user_input(state: AgentState) -> dict:
        ...
        # Check for verbose/quiet mode
        if user_input.lower() == "verbose":
            print("[MODE] Verbose mode enabled")
            return {
                "user_input": "",
                "should_exit": False,
                "verbose": True,
    ...
    def call_llm(state: AgentState) -> dict:
        ...
        # Use in each node to print tracing info
    ...
    def route_after_input(state: AgentState) -> str:
        ...
        # If it's a command, skip LLM and loop back
        if state.get("is_command", False):
            return "get_user_input" # Direct loop back
    ...
    graph_builder.add_conditional_edges(
        ...
        route_after_input,      # Routing function that examines state
        {
            ...
            "get_user_input": "get_user_input", # Loop back for commands
